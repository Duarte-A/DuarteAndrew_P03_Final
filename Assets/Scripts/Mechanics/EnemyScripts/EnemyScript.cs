...
public class EnemyScript : MonoBehaviour
{
    ...
    public void OnPlayerCounter(EnemyScript target)
    {
        if (target == this)
        {
            PrepareAttack(false);
    ...
    public void OnPlayerTrajectory(EnemyScript target)
    {
        if (target == this)
        {
            StopEnemyCoroutines();
    ...
    public void KnockoutSFX(EnemyScript target)
    {
        _audioSource.PlayOneShot(_koSound, _koVolume);
    }
